...
export class ServiceAllService<T> {
  ...
  create(T: T, endpoint: string): Observable<T> {
    return this.http.post<T>(this.environmentUrl + endpoint, T, this.loginservice.header())
      .pipe(
        map(obj => obj),
  ...
  read(endpoint: string): Observable<T[]> {
    return this.http.get<T[]>(`${this.environmentUrl + endpoint}`, this.loginservice.header())
      .pipe(
        map(obj => obj),
        catchError(e => this.utilService.erroHandler(e))
      );
  ...
  readById(id: string, endpoint: string): Observable<T> {
    ...
    return this.http.get<T>(url, this.loginservice.header())
      .pipe(
        map(obj => obj),
        catchError(e => this.utilService.erroHandler(e))
      );
  ...
  update(T: T, endpoint: string): Observable<T> {
    return this.http.put<T>(this.environmentUrl + endpoint, T, this.loginservice.header())
      .pipe(
        map(obj => obj),
        catchError(e => this.utilService.erroHandler(e))
      );
  ...
  delete(id: number, endpoint: string): Observable<T> {
    ...
    return this.http.delete<T>(url, this.loginservice.header())
      .pipe(
        map(obj => obj),
        catchError(e => this.utilService.erroHandler(e))
      )
