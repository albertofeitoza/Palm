...
function MatHorizontalStepper_ng_container_1_Template(rf, ctx) { if (rf & 1) {
    ...
    ɵngcc0.ɵɵlistener("click", function MatHorizontalStepper_ng_container_1_Template_mat_step_header_click_1_listener() { const step_r68 = ctx.$implicit; return step_r68.select(); })("keydown", function MatHorizontalStepper_ng_container_1_Template_mat_step_header_keydown_1_listener($event) { ɵngcc0.ɵɵrestoreView(_r74); const ctx_r73 = ɵngcc0.ɵɵnextContext(); return ctx_r73._onKeydown($event); });
    ɵngcc0.ɵɵelementEnd();
    ɵngcc0.ɵɵtemplate(2, MatHorizontalStepper_ng_container_1_div_2_Template, 1, 0, "div", 5);
    ɵngcc0.ɵɵelementContainerEnd();
} if (rf & 2) {
    const step_r68 = ctx.$implicit;
    const i_r69 = ctx.index;
    const isLast_r70 = ctx.last;
    const ctx_r66 = ɵngcc0.ɵɵnextContext();
    ɵngcc0.ɵɵadvance(1);
    ɵngcc0.ɵɵproperty("tabIndex", ctx_r66._getFocusIndex() === i_r69 ? 0 : 0 - 1)("id", ctx_r66._getStepLabelId(i_r69))("index", i_r69)("state", ctx_r66._getIndicatorType(i_r69, step_r68.state))("label", step_r68.stepLabel || step_r68.label)("selected", ctx_r66.selectedIndex === i_r69)("active", step_r68.completed || ctx_r66.selectedIndex === i_r69 || !ctx_r66.linear)("optional", step_r68.optional)("errorMessage", step_r68.errorMessage)("iconOverrides", ctx_r66._iconOverrides)("disableRipple", ctx_r66.disableRipple);
    ɵngcc0.ɵɵattribute("aria-posinset", i_r69 + 1)("aria-setsize", ctx_r66.steps.length)("aria-controls", ctx_r66._getStepContentId(i_r69))("aria-selected", ctx_r66.selectedIndex == i_r69)("aria-label", step_r68.ariaLabel || null)("aria-labelledby", !step_r68.ariaLabel && step_r68.ariaLabelledby ? step_r68.ariaLabelledby : null);
    ɵngcc0.ɵɵadvance(1);
    ɵngcc0.ɵɵproperty("ngIf", !isLast_r70);
} }
function MatHorizontalStepper_div_3_Template(rf, ctx) { if (rf & 1) {
    const _r78 = ɵngcc0.ɵɵgetCurrentView();
    ɵngcc0.ɵɵelementStart(0, "div", 7);
    ɵngcc0.ɵɵlistener("@stepTransition.done", function MatHorizontalStepper_div_3_Template_div_animation_stepTransition_done_0_listener($event) { ɵngcc0.ɵɵrestoreView(_r78); const ctx_r77 = ɵngcc0.ɵɵnextContext(); return ctx_r77._animationDone.next($event); });
    ...
    ɵngcc0.ɵɵproperty("@stepTransition", ctx_r67._getAnimationDirection(i_r76))("id", ctx_r67._getStepContentId(i_r76));
    ɵngcc0.ɵɵattribute("tabindex", ctx_r67.selectedIndex === i_r76 ? 0 : null)("aria-labelledby", ctx_r67._getStepLabelId(i_r76))("aria-expanded", ctx_r67.selectedIndex === i_r76);
    ɵngcc0.ɵɵadvance(1);
    ɵngcc0.ɵɵproperty("ngTemplateOutlet", step_r75.content);
} }
function MatVerticalStepper_div_0_Template(rf, ctx) { if (rf & 1) {
    ...
    ɵngcc0.ɵɵlistener("click", function MatVerticalStepper_div_0_Template_mat_step_header_click_1_listener() { const step_r80 = ctx.$implicit; return step_r80.select(); })("keydown", function MatVerticalStepper_div_0_Template_mat_step_header_keydown_1_listener($event) { ɵngcc0.ɵɵrestoreView(_r85); const ctx_r84 = ɵngcc0.ɵɵnextContext(); return ctx_r84._onKeydown($event); });
    ɵngcc0.ɵɵelementEnd();
    ɵngcc0.ɵɵelementStart(2, "div", 3);
    ɵngcc0.ɵɵelementStart(3, "div", 4);
    ɵngcc0.ɵɵlistener("@stepTransition.done", function MatVerticalStepper_div_0_Template_div_animation_stepTransition_done_3_listener($event) { ɵngcc0.ɵɵrestoreView(_r85); const ctx_r86 = ɵngcc0.ɵɵnextContext(); return ctx_r86._animationDone.next($event); });
    ...
    const step_r80 = ctx.$implicit;
    const i_r81 = ctx.index;
    const isLast_r82 = ctx.last;
    const ctx_r79 = ɵngcc0.ɵɵnextContext();
    ɵngcc0.ɵɵadvance(1);
    ɵngcc0.ɵɵproperty("tabIndex", ctx_r79._getFocusIndex() == i_r81 ? 0 : 0 - 1)("id", ctx_r79._getStepLabelId(i_r81))("index", i_r81)("state", ctx_r79._getIndicatorType(i_r81, step_r80.state))("label", step_r80.stepLabel || step_r80.label)("selected", ctx_r79.selectedIndex === i_r81)("active", step_r80.completed || ctx_r79.selectedIndex === i_r81 || !ctx_r79.linear)("optional", step_r80.optional)("errorMessage", step_r80.errorMessage)("iconOverrides", ctx_r79._iconOverrides)("disableRipple", ctx_r79.disableRipple);
    ɵngcc0.ɵɵattribute("aria-posinset", i_r81 + 1)("aria-setsize", ctx_r79.steps.length)("aria-controls", ctx_r79._getStepContentId(i_r81))("aria-selected", ctx_r79.selectedIndex === i_r81)("aria-label", step_r80.ariaLabel || null)("aria-labelledby", !step_r80.ariaLabel && step_r80.ariaLabelledby ? step_r80.ariaLabelledby : null);
    ɵngcc0.ɵɵadvance(1);
    ɵngcc0.ɵɵclassProp("mat-stepper-vertical-line", !isLast_r82);
    ɵngcc0.ɵɵadvance(1);
    ɵngcc0.ɵɵproperty("@stepTransition", ctx_r79._getAnimationDirection(i_r81))("id", ctx_r79._getStepContentId(i_r81));
    ɵngcc0.ɵɵattribute("tabindex", ctx_r79.selectedIndex === i_r81 ? 0 : null)("aria-labelledby", ctx_r79._getStepLabelId(i_r81))("aria-expanded", ctx_r79.selectedIndex === i_r81);
    ɵngcc0.ɵɵadvance(2);
    ɵngcc0.ɵɵproperty("ngTemplateOutlet", step_r80.content);
} }
